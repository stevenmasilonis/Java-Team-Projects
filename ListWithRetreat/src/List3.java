...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        /*
         * Setting value for newly added node: data = x, next node = nodes
         * previously right of lastLeft, previous node = lastLeft
         */
        //firstRight.data = x;
        //firstRight.next = lastLeft.next;
        //firstRight.previous = lastLeft;

        /*
         * Setting values surrounding firstRight to point towards it.
         */
        //lastLeft.next = firstRight;
        //firstRight.next.previous = firstRight;
        newFront.data = x;
        this.lastLeft.next.previous = newFront;
        newFront.previous = this.lastLeft;
        newFront.next = this.lastLeft.next;
